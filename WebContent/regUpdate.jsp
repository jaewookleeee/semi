...
<html>
	<head>
		...
		<style>
			div#main{ position: absolute; border: 1.5px solid #A4A4A4; width: 310px; height: 720px;
	            left: 40%; top: 100px;  text-align: center;}
	        span#regTxt{ position: absolute; left: 89px; top: 10px; font-size: 20px;      }
	        ...
	        b#num{position: absolute; left: 15px; top: 530px; font-size: 13px;   }
	        b#phone{ position: absolute; left: 15px; top: 590px; font-size: 13px;   }
	        ...
	        input#regNewPw{ position: absolute; left: 15px; top: 195px;  width: 200px; height: 25px; font-size: 10px;             }
	        input#regNewPwChk{ position: absolute; left: 15px; top: 255px; width: 200px; height: 25px; font-size: 10px;             }
	        input#regName{ position: absolute; left: 15px; top: 315px; width: 200px; height: 25px; font-size: 10px; }
	        ...
	        select#regBirthYear{ position: absolute; left: 15px; top: 435px; }
	        select#regBirthMonth{ position: absolute; left: 70px; top: 435px; }
	        select#regBirthDay{ position: absolute; left: 110px; top: 435px;  }
	        
	        input#regEmail{ position: absolute; left: 15px; top: 495px; width: 200px; height: 25px; font-size: 10px;             }
	        ...
	        button#cancel{ position: absolute; left: 180px; top: 675px; width: 50px; height: 25px; 
	            color: white; background-color: black; border-style: none; font-size: 10px; }
	        button#save{ position: absolute; left: 240px; top: 675px; width: 50px; height: 25px;
